...
if (!class_exists('Emu_Updater')) {
    class Emu_Updater {
        ...
        public function __construct($plugin_slug, $self_plugin_dir) {
            ...
            // Hooks condicionais
            add_action('load-update-core.php', [$this, 'add_update_hooks'], 5);
            add_action('load-plugins.php', [$this, 'add_update_hooks'], 5);
            add_action('upgrader_process_complete', [$this, 'add_post_update_hooks'], 5);
        }
    
        public function add_update_hooks() {
            add_filter('plugins_api', [$this, 'plugin_info'], 20, 3);
            add_filter('site_transient_update_plugins', [$this, 'check_for_update']);
        }
    
        public function add_post_update_hooks() {
...
if (!function_exists('emu_load_plugin_updates')) {
function emu_load_plugin_updates() {
